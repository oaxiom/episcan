...
wget -c ftp://orengoftp.biochem.ucl.ac.uk/cath/releases/latest-release/sequence-data/funfam-hmm3.lib.gz
wget -c ftp://ftp.jcvi.org/pub/data/TIGRFAMs/14.0_Release/TIGRFAMs_14.0_HMM.tar.gz
